...
| FR-12 | Nhật ký thời gian | Hiển thị báo cáo thời gian theo ngày. | Ngày xem, dữ liệu lịch và nhật ký thời gian. | Lấy dữ liệu theo ngày, kết hợp lịch kế hoạch và nhật ký không gắn lịch. | Bảng báo cáo gồm hoạt động, danh mục, thời gian kế hoạch, thời lượng kế hoạch và ghi chú. | Trang có định hướng xem báo cáo, không chỉnh sửa thực tế thủ công. |
...
| FR-15 | Trợ lý thông minh | Đưa ra nhận xét và khuyến nghị dựa trên dữ liệu lịch, nhật ký, nhắc nhở và ngày quan trọng. | Dữ liệu cá nhân của người dùng trong hệ thống. | Tổng hợp số liệu, phát hiện tình huống quá tải, thiếu theo dõi, khoảng trống hoặc sự kiện sắp tới. | Danh sách gợi ý với mức độ thông tin, cảnh báo hoặc thành công. | Dựa trên quy tắc xử lý dữ liệu nội bộ của hệ thống. |
